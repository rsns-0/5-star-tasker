...
export type flag_key_to_deep_l_iso_code = {
	flag_key: string
	iso_code: string
}
export type flag_key_to_deep_l_iso_code_materialized = {
	flag_key: string
	iso_code: string
}
...
export type DB = {
	...
	flag_key_to_deep_l_iso_code: flag_key_to_deep_l_iso_code
	flag_key_to_deep_l_iso_code_materialized: flag_key_to_deep_l_iso_code_materialized
