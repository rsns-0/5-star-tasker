	...
	return prisma.$extends({
		...
		model: {
			logs: {
				 ...
				 * @returns A promise that resolves when the log entry is
				 *   created.
				 */
				...
				/**
				 * The function "dump" takes an object, converts it to a JSON
				 * string, parses it back to a JSON object, and then creates a
				 * log entry with the original message and the parsed JSON
				 * object.
				 *
				 * @param obj - The parameter `obj` is of type `O.Object`.
				 * @returns The result of the `client.logs.create()` method,
				 *   which is a promise.
				 */
