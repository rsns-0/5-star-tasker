...
export default Prisma.defineExtension((client) => {
	return client.$extends({
		model: {
			$allModels: {
				/**
				 * Pulls the specified field from the model in the return
				 * result.
				 *
				 * @typeParam T The model type
				 * @typeParam K The return type of Prisma `findMany` method on
				 *   model T
				 * @param field The field to retrieve from the model records
				 * @param where Optional conditions to match the records to
				 *   retrieve
				 * @returns An array comprising of the values of the specified
				 *   field in the model records satisfying the where condition
				 */
				...
				/**
				 * Produces a case insensitive search for the specified string
				 * field.
				 *
				 * @typeParam T The model type
				 * @typeParam K The return type of Prisma `findMany` method on
