...
describe("TranslationServiceError", () => {
	...
	const axiosErr = TranslationServiceError.fromError(new AxiosError("test", axiosStatusCode))
	const zodErr = TranslationServiceError.fromError(new ZodError(issues))
