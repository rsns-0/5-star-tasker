import { descendToFolderThenGetExportsFromFolder, goToAncestorFolder } from '../services/fileParsingService';
...
describe('getExportsFromFilesInFolder', () => {
	...
	it('should throw an error if the specified folder is not found', () => {
		expect(() => descendToFolderThenGetExportsFromFolder('nonExistentFolder', startingPoint)).toThrow(TraverserError);
	});
